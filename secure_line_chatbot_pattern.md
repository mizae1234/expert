...
### 2.2 การดักจับป้องกันการสืบค้นตารางประวัติแชทล็อก (ChatLog Privacy Safeguard)

เพื่อความปลอดภัยขั้นสูงสุดในการเก็บรักษาข้อมูลของลูกค้าและประวัติการสอบถามในบริษัท ห้ามไม่ให้ผู้ใช้งานสามารถสั่งงาน AI ให้คิวรี่ตาราง `ChatLog` หรือเข้าถึงข้อมูลล็อกประวัติการคุยย้อนหลังเด็ดขาด โดยในระบบ Prompt Instruction ต้องกำหนดเงื่อนไขห้ามเข้าถึงตารางดังกล่าว และเมื่อตรวจพบความพยายามในการเข้าถึง ให้ปฏิเสธอย่างสุภาพทันที:

* **กฎเหล็กใน System Instruction**:
  ```
